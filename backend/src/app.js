...
const platformOnboardingRoutes = require("./routes/platformOnboarding");
...
const storeTransferRoutes = require("./routes/storeTransfers");
const storeReplenishmentRequestRoutes = require("./routes/storeReplenishmentRequests");
const companyStoreSettlementRoutes = require("./routes/companyStoreSettlements");
const storeAccessRoutes = require("./routes/storeAccess");
...
const { staffNotificationsRouter, staffDashboardRouter } = require("./routes/staffNotifications");
...
const storeLineChannelRoutes = require("./routes/storeLineChannels");
...
const staffEvaluationRoutes = require("./routes/staffEvaluations");
...
app.use("/api/platform-admin/onboarding", platformOnboardingRoutes);
app.use("/api/store-access", storeAccessRoutes);
app.use("/api", storeAccessRoutes);
app.use("/api/saas-admin", saasAdminRoutes);
app.use("/api/platform-admin", saasAdminRoutes);
app.use("/api/company", companyRoutes);
app.use("/api/store-transfers", storeTransferRoutes);
app.use("/api/store-replenishment-requests", storeReplenishmentRequestRoutes);
app.use("/api/company-store-settlements", companyStoreSettlementRoutes);
...
app.use("/api/store-line-channels", storeLineChannelRoutes);
...
app.use("/api/repair-confirmations", repairConfirmationRoutes);
...
app.use("/api/staff-evaluations", staffEvaluationRoutes);
