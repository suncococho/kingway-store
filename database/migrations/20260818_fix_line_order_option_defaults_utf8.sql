...
SET @line_option_assert_columns_sql := IF(
  BINARY @line_option_schema = BINARY 'kingway_store' AND @line_option_column_count = 2,
  'DO 0',
...
SET @line_option_defaults_sql := IF(
  BINARY @line_option_current_title_hex = BINARY @line_option_title_hex
    AND BINARY @line_option_current_description_hex = BINARY @line_option_description_hex,
  'DO 0',
  'ALTER TABLE line_order_option_settings ALTER COLUMN page_title SET DEFAULT _utf8mb4 0xE981B8E69387E682A8E99C80E8A681E79A84E9858DE4BBB6, ALTER COLUMN page_description SET DEFAULT _utf8mb4 0xE58FAFE4BE9DE785A7E99C80E6B182E981B8E69387E9858DE4BBB6EFBC8CE4B99FE58FAFE4BBA5E795A5E9818EE6ADA4E6ADA5E9A99F, ALGORITHM=INSTANT, LOCK=DEFAULT'
);
PREPARE line_option_defaults_stmt FROM @line_option_defaults_sql;
EXECUTE line_option_defaults_stmt;
DEALLOCATE PREPARE line_option_defaults_stmt;
